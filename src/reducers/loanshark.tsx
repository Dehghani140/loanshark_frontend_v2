...
export default function loansharkReducer(action:any, state:any = initialState) {
  switch (action.type) {
    ...
    case ActionType.CHANGE_SELECTED_PAIR:
      return {...state,selectedPair: action.payload};
    case ActionType.CHANGE_NUMBER_OF_ETH:
      return {...state,numberOfEth: action.payload};
    case ActionType.CHANGE_NUMBER_OF_AVAX:
      return {...state,numberOfAvax: action.payload};
    case ActionType.CHANGE_AAVE_BTC_BORROW_RATE:
      return {...state,aaveBtcBorrowRate: action.payload};
    case ActionType.CHANGE_USER_DEPOSIT_BALANCE_ETH:
      return {...state,userDepositBalanceEth: action.payload};
    case ActionType.CHANGE_USER_DEPOSIT_BALANCE_AVAX:
      return {...state,userDepositBalanceAvax: action.payload};
    case ActionType.CHANGE_USER_DEBT_BALANCE_BTC:
    ...
    case ActionType.CHANGE_LIQUDATION_PRICE:
      var newState2 = state;
      if (action.payload.ETHBTC) {
...
// export default function loansharkReducer(action) {
