                            ...
                            <RoundShapeButton
                                ...
                                onClick={() => {
                                    ...
                                    toggleAction(
                                        ...
                                        (Number(healthFactorPercentage) < 1.05 || Number(singleTopupAmount) > Number(stakeAmount) || Number(stakeAmount) > Number((stateSmartvault.myProtectingSmartVault == "BTC" ? state.myBTCAmount : state.myETHAmount)) ?
